...
BLOG_AUTHOR = "Lucas Ramony"  # (translatable)
BLOG_TITLE = "HackerToolkitsBr"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hackertoolkits.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hackertoolkits.github.io/"
BLOG_EMAIL = "luca.ras@hotmail.com"
BLOG_DESCRIPTION = "Site voltado para segurança da informção"  # (translatable)
